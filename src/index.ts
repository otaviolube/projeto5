...
nomeFormulario = document.querySelector("body > div > div.main-agileinfo > div > form > input:nth-child(1)") as HTMLInputElement;

emailFormulario = document.querySelector("body > div > div.main-agileinfo > div > form > input.text.email") as HTMLInputElement;

idadeFormulario = document.querySelector("body > div > div.main-agileinfo > div > form > input:nth-child(3)") as HTMLInputElement;

botaoFormulario = document.querySelector("body > div > div.main-agileinfo > div > form > input[type=submit]:nth-child(4)") as HTMLInputElement;
